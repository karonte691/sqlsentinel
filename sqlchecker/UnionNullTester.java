...
public class UnionNullTester {
    private int numCols = 1;
    private String nullCols = "NULL";
    ...
    public UnionNullTester(String url_vuln, String unionCodeInj, String numberColumnsMessage){
        this.url_vuln = url_vuln;
        this.numberColumnsMessage = numberColumnsMessage;
        this.unionCodeInj = unionCodeInj;
    }
    
    public boolean checkNullUnionInj(){
    ...
    private String makeUnionUrl(){  
        if(numCols == 1)
            url_vuln_union_part = url_vuln_union_part + nullCols;
        else
                url_vuln_union_part += "," + nullCols;
        numCols++;
        return url_vuln_union_part;
    }
    
    public String getNullUnionSQLInjUrl() {
