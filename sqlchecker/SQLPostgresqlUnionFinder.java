...
import sqlsentinel.sqlchecker.UnionNullTester;

public class SQLPostgresqlUnionFinder implements SQLCommonCheck {
    private String url_vuln = null;
    private String union_url_vuln;
    private final String numberColumnsMessage = "each UNION query must have the same number of columns";
    private final String unionCodeInj = "+UNION+SELECT+";
    private UnionNullTester unionNullTest = null;
    
    public SQLPostgresqlUnionFinder(String url_vuln){
    ...
    public boolean checkVuln() {
        try
        {
            ...
            return false;
             ...
             Logger.getLogger(SQLPostgresqlUnionFinder.class.getName()).log(Level.SEVERE, null, ex);
        }       
        return false;
    }
